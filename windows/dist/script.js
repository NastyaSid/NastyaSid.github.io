...
var images = function images() {
  ...
  workSecton.appendChild(imgPopup); // imgPopup.style.cssText = 'justifyContent: center; alignItems: center; display: none;';

  imgPopup.style.justifyContent = 'center';
  imgPopup.style.alignItems = 'center';
  imgPopup.style.display = 'none';
  imgPopup.appendChild(bigImg);
  workSecton.addEventListener('click', function (e) {
    e.preventDefault();
    var target = e.target;
